// Файл: StoreManagement.Services/MyCollectionExtensions.cs
using System;
...
using StoreManagement.Domain;     // Доступ к Goods (для примера с Average)
...
namespace StoreManagement.Services
{
    ...
    public static class MyCollectionExtensions
    {
        ...
        public static MyNewCollection<T> Filter<T>(this MyNewCollection<T> collection, Func<T, bool> predicate)
        {
            ...
            // Используем стандартный LINQ Where и конструктор MyNewCollection
        ...
        /// (Пример агрегации - можно сделать более универсальным)
        /// </summary>
        ...
        public static decimal AggregateAverage(this MyNewCollection<Goods> collection, Func<Goods, decimal> selector)
        {
            ...
            // Используем стандартный LINQ Average
            // Добавляем проверку на пустую коллекцию, чтобы избежать деления на ноль
            if (!collection.Any())
            {
                return 0m;
            }
        ...
        public static MyNewCollection<T> SortBy<T, TKey>(this MyNewCollection<T> collection, Func<T, TKey> keySelector)
        {
            ...
            // Используем стандартный LINQ OrderBy
        ...
        public static IEnumerable<IGrouping<TKey, T>> GroupByCriteria<T, TKey>(this MyNewCollection<T> collection, Func<T, TKey> keySelector)
        {
            ...
            // Используем стандартный LINQ GroupBy
